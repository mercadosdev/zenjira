...
export default function QuickAddModal({ hubId, quadros, onClose }) {
  ...
  const handleSave = async () => {
    ...
    if (isIgs && !responsavel) return alert("O Responsável é obrigatório."); 
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="space-y-4 z-[80] relative">
            ...
            <div className={`grid ${isIgs ? 'grid-cols-2' : 'grid-cols-1'} gap-4 z-[60] relative`}>
            ...
            <button onClick={handleSave} disabled={loading} className="w-full py-3 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl shadow-lg transition-colors disabled:opacity-50">
